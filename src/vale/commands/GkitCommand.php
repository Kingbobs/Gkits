...
class GkitComamnd extends PluginCommand{

    /** @var array */
    public $plugin;

    public function __construct(Gkits $plugin) {
        $key = Gkits::getInstance()->getConfig()->get("CommandName");
        parent::__construct($key, $plugin);
        $this->setDescription("Give players gkit");
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): bool{
        ...
        if (!empty($args[0])) {
            ...
            if ($target == true) {
                ...
                $name = Gkits::getInstance()->getConfig()->get("ButcherItemName");
                ...
                $leg->setLore([
                    ...
                    '§r§7Tap to recieve random gkit item',
                    '§r§c* Butcher Gkit',
